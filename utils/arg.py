...
def arguments():
    ...
    parser.add_argument("--method", type=str, default="both", choices=["both","hole","upnp"], help="Choose your connection method. By default the program will test both method if one fail. First method (hole) is with the hole punching (pure p2p). The second method is for upnp configuration.")
